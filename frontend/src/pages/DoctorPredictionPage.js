    ...
    <div className="page-container">
      ...
      <div className="content-wrapper" style={{ maxWidth: '900px' }}>
        ...
        <div className="alert alert-info" style={{ marginBottom: '28px', display: 'flex', alignItems: 'center', gap: '12px' }}>
          ...
          <span>You are running this prediction as a <strong>Doctor</strong>. Enter the patient name and clinical values below. </span>
        </div>
        ...
        {selectedDisease && (
          <div>
            ...
            {/* Patient pill */}
            <div style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', padding: '8px 16px', background: 'rgba(16,185,129,0.08)', border: '1px solid rgba(16,185,129,0.25)', borderRadius: '30px', marginBottom: '20px' }}>
