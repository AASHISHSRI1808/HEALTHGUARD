          ...
          <Link to="/" style={{display:'inline-flex',alignItems:'center',gap:'10px',textDecoration:'none'}}>
            <div style={{width:'42px',height:'42px',background:'var(--g-brand)',borderRadius:'13px',display:'flex',alignItems:'center',justifyContent:'center'}}>
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" fill="none" width="26" height="26">
                ...
                <rect x="28" y="22" width="8" height="20" rx="2" fill="#059669"/>
                <rect x="22" y="28" width="20" height="8" rx="2" fill="#059669"/>
                <polyline points="18,32 22,32 25,26 29,38 33,28 36,36 38,32 46,32" stroke="#059669" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" fill="none" opacity="0.7"/>
              </svg>
            </div>
