  ...
  return (
    <div style={{ minHeight: '100vh', background: 'var(--bg-base)' }}>
      ...
      <section style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', paddingTop: '66px', position: 'relative', overflow: 'hidden' }}>
        {/* Mesh background */}
        <div style={{ position: 'absolute', inset: 0, background: `radial-gradient(ellipse at 18% 40%, var(--accent-soft) 0%, transparent 55%), radial-gradient(ellipse at 82% 25%, rgba(13,148,136,0.09) 0%, transparent 50%), radial-gradient(ellipse at 55% 88%, rgba(2,132,199,0.07) 0%, transparent 52%)` }} />
        {/* Dot grid */}
      ...
      <section style={{ padding: '96px 24px', background: 'var(--bg-surface)' }}>
        <div style={{ maxWidth: '1100px', margin: '0 auto' }}>
          ...
          <div className="grid-3" style={{ gap: '24px' }}>
            {[
              { n:'01', emoji:'📝', title:'Enter Clinical Data',   desc:'Input your health parameters — blood pressure, cholesterol, liver enzymes, voice biomarkers. Guided form for each disease type.', color:'var(--cyan-500)',   soft:'rgba(8,145,178,0.1)',   border:'rgba(8,145,178,0.2)'   },
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '56px', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: '1 1 380px', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '14px' }}>
              {[
                ...
                { emoji:'👨‍⚕️',title:'Doctor Network', desc:'Find & book instantly',color:'var(--cyan-500)',   soft:'rgba(8,145,178,0.1)'   },
          ...
          <div style={{ background: 'var(--gradient-brand)', borderRadius: '32px', padding: '64px 48px', boxShadow: '0 28px 80px var(--accent-glow)', position: 'relative', overflow: 'hidden' }}>
            ...
            <div style={{ position: 'relative', zIndex: 1 }}>
              ...
              <div style={{ display: 'flex', gap: '12px', justifyContent: 'center', flexWrap: 'wrap' }}>
                <Link to="/register" style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', padding: '14px 28px', borderRadius: '14px', background: 'white', color: '#059669', textDecoration: 'none', fontWeight: 900, fontSize: '15px', boxShadow: '0 4px 20px rgba(0,0,0,0.2)', transition: 'all 0.2s' }}
      ...
      <footer style={{ borderTop: '1px solid var(--border-subtle)', padding: '28px 24px', background: 'var(--bg-surface)' }}>
        <div style={{ maxWidth: '1100px', margin: '0 auto', display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: '14px' }}>
          ...
          <p style={{ color: 'var(--text-faint)', fontSize: '13px', fontWeight: 600 }}>© 2026 HealthGuard · AI Disease Prediction .</p>
